...
Until the package is on npm, you install from source, so you're running the code you can see in front of you. When it is published, releases will carry signed build provenance generated by the publish pipeline. You'll be able to confirm a release was built from this source with:
